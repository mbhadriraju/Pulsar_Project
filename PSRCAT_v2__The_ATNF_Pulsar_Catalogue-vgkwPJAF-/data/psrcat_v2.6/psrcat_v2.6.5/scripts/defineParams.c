...
int define_surveys(char surveynames[MAX_STRLEN][MAX_SURVEYS])
{
  ...
  strcpy(surveynames[32],"fast_crafts");
  strcpy(surveynames[33],"fast_gpps");
  strcpy(surveynames[34],"chime");
  strcpy(surveynames[35],"meerkat_trapum");
  strcpy(surveynames[36],"tulipp");
  strcpy(surveynames[37],"mwa_smart");
  strcpy(surveynames[38],"pumps");
  strcpy(surveynames[39],"mmgps-l");
  strcpy(surveynames[40],"gbt820");
  survey_num=40;
  return survey_num;
}
...
void defineParameters(paramtype *defParam)
{
  ...
  addParameter(defParam,"SURVEY","%-55.55s","SURVEY"," ","Surveys that detected pulsar (discovery survey first)",5,0);
  ...
  addParameter(defParam,"PML","%9.3f","PML      ","(mas/yr)","Proper motion in l (mas/yr)",1,0);
  addParameter(defParam,"PMB","%9.3f","PMB      ","(mas/yr)","Proper motion in b (mas/yr)",1,0);
